...
insert into `caddycom`.`caddy` (id, name, phone_number, golf_field_id, team, team_role, gender, holiday, changed_holiday, birth, address, address_detail, career, role, point, refresh_token, off_part, caddy_type, ctype) values
        (1, '더미캐디', '010-1111-1111', 1, '1조', 0, 1, '1,2', '5,6', '2020-02-02', '서울특별시 강남구', '강남구 6층', '3년', 4, 100, null, '1,2', '마미반','H');
