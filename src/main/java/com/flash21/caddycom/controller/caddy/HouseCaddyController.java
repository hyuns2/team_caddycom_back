...
public class HouseCaddyController {
    ...
    @GetMapping("/{caddyId}")
    public ResponseEntity<HouseCaddyResponse.Detail> getHouseCaddy(@PathVariable Long caddyId) {
        HouseCaddyResponse.Detail result = houseCaddyService.getHouseCaddy(caddyId);
    ...
    public ResponseEntity<Void> updateHouseCaddy(@PathVariable Long caddyId,
                                                 @ModelAttribute HouseCaddyRequest.UpdateByCaddy dto) {
